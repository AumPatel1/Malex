"""
Multi-agent defination and system for ML models class.
"""
...
from smolagents import CodeAgent, LiteLLModel , AgentText

from Malex.agents.dataset_analyser import EdaAgent
from Malex.agents.dataset_splitter import DatasetSplitterAgent
from Malex.agents.feature_engineer import FeatureEngineeringAgent
from Malex.agents.model_packager import ModelPackagerAgent
from Malex.agents.model_planner import ModelPlannerAgent
from Malex.agents.model_tester import ModelTesterAgent
from Malex.agents.model_trainer import ModelTrainerAgent
from Malex.agents.schema_resolver import SchemaResolverAgent
from Malex.config import config
...
from Malex.internal.models.entities.metric import MetricComparator, ComparisonMethod
from Malex.core.entities.solution import Solution
from Malex.core.interfaces.predictor import Predictor
from Malex.tools.datasets import get_latest_datasets
from Malex.tools.evaluation import get_review_finalised_model, get_solution_performances
from Malex.tools.metrics import get_select_target_metric
from Malex.tools.response_formatting import (
    format_final_orchestrator_agent_response,
)
from Malex.tools.training import register_best_solution
...
class PlexeAgent:
    ...
    def __init__(
        ...
        ml_researcher_model_id: str = "openai/gpt-4o",            ml_engineer_model_id: str = "anthropic/claude-3-7-sonnet-20250219",
        ...
        self.schema_resolver = SchemaResolverAgent(
    ...
    def run(self,task,addistional_args:dict)->ModelGenerationResult:
        
        object_registory = ObjectRegistry()
        ...
        try:
            if logger.isEnableFor(looging.DEBUG):
                logger.debug(result)

            if isinstance(result,AgentText):
                result = json.loads(str(result))

            best_solution = object_registory.get(Solution,"BestONE")
