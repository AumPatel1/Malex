...
from Malex.internal.common.utils.agents import get_prompt_templates
from Malex.tools.datasets import get_dataset_preview, get_dataset_reports, get_latest_datasets
from Malex.tools.schemas import (
    register_global_schemas,
    get_global_schemas,
    register_solution_schemas,
    get_solution_schemas,
)
from Malex.tools.solutions import list_solutions
